...
<div class="row" >
  ...
  <div class="col-md-2 a3" style="font-size: 14px;color: white;text-align: center;">
  	...
  	<label style="cursor: pointer;" onclick="test()">测试</label>
  </div>
</div>
</body>
...
//打开新的窗口
function openWindow(){
	window.open("http://192.168.10.65:8088/Top7/page/qd.jsp","_blank","toolbar=no, location=no, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=800, height=800");
}
//启动-停止tomcat
