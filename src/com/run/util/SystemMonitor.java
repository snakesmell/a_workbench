...
//        System.out.println(usedMemory);
        ...
        map.put(CommandUtils.SystemList, list);
        map.put(CommandUtils.TotalMemorySize, totalMemorySize);
        map.put(CommandUtils.UsedMemory, usedMemory);
        map.put(CommandUtils.OsName, osName);
        return map;
	}
